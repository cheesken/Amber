...
interface VideoEvidenceScreenProps {
    onBack: () => void;
}

export default function VideoEvidenceScreen({ onBack }: VideoEvidenceScreenProps) {
    return (
            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.content}>
                    <View style={styles.emptyStateContainer}>
                        <Ionicons name="videocam-outline" size={64} color="#ccc" style={styles.emptyIcon} />
                        <Text style={styles.emptyTitle}>No Video entries yet</Text>
                        <Text style={styles.emptySubtitle}>Videos you save will appear here.</Text>
                    </View>
                </ScrollView>
            </View>
        </SafeAreaView>
