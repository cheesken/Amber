...
interface TextEvidenceScreenProps {
    onBack: () => void;
}

export default function TextEvidenceScreen({ onBack }: TextEvidenceScreenProps) {
    return (
            ...
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    <TouchableOpacity onPress={onBack} style={styles.backButton}>
                        ...
                        <Text style={styles.headerTitle}>Text Evidence</Text>
                    </TouchableOpacity>
                </View>

                <ScrollView contentContainerStyle={styles.content}>
                    <View style={styles.emptyStateContainer}>
                        <Ionicons name="document-text-outline" size={64} color="#ccc" style={styles.emptyIcon} />
                        <Text style={styles.emptyTitle}>No Text entries yet</Text>
                        <Text style={styles.emptySubtitle}>Written evidence you save will appear here.</Text>
                    </View>
                </ScrollView>
            </View>
        </SafeAreaView>
