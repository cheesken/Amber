...
interface AudioEvidenceScreenProps {
    onBack: () => void;
}

export default function AudioEvidenceScreen({ onBack }: AudioEvidenceScreenProps) {
    return (
            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.content}>
                    <View style={styles.emptyStateContainer}>
                        <Ionicons name="mic-outline" size={64} color="#ccc" style={styles.emptyIcon} />
                        <Text style={styles.emptyTitle}>No Audio entries yet</Text>
                        <Text style={styles.emptySubtitle}>Audio recordings you save will appear here.</Text>
                    </View>
                </ScrollView>
            </View>
        </SafeAreaView>
